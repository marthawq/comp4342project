...
public class SubtractionCongrats extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SubtractionCongrats.this, SubtractionGame.class);
                startActivity(i);
            }
        });
        ...
        btn_go_to_homepage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(SubtractionCongrats.this, Home.class);
                startActivity(i);
            }
        });
