...
public class AddCongrats extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(AddCongrats.this, AddGame.class);
                startActivity(i);
            }
        });
        ...
        btn_go_to_homepage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(AddCongrats.this, Home.class);
                startActivity(i);
            }
        });
