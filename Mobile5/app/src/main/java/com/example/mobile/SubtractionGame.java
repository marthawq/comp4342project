...
public class SubtractionGame extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Q = getResources().getStringArray(R.array.questions_game_minus);
        A = getResources().getStringArray(R.array.answers_game_minus);
                    ...
                    if (view.getId() == R.id.iv_alien) {
                        if (ans_a == random_Q){
                            ...
                            if (num == Q.length) {
                                ...
                                Intent i = new Intent(SubtractionGame.this, GameEnd.class);
                                startActivity(i);
                            }
