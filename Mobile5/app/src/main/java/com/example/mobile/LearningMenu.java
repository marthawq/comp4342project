...
public class LearningMenu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    NavigationView nv;
    public DrawerLayout drawerLayout;
    public ActionBarDrawerToggle actionBarDrawerToggle;
    LinearLayout add_layout, subtract_layout, multiply_layout, division_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learning_menu);
        ...
        subtract_layout = findViewById(R.id.subtract_layout);
        multiply_layout = findViewById(R.id.multiply_layout);
        division_layout = findViewById(R.id.division_layout);

        add_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LearningMenu.this, AddLearn.class);
                startActivity(i);
            }
        });

        subtract_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LearningMenu.this, SubtractionLearn.class);
                startActivity(i);
            }
        });

        multiply_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LearningMenu.this, MultiplyLearn.class);
                startActivity(i);
            }
        });

        division_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LearningMenu.this, DivideLearn.class);
                startActivity(i);
            }
        });
