...
public class GameEnd extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{

    NavigationView nv;
    public DrawerLayout drawerLayout;
    public ActionBarDrawerToggle actionBarDrawerToggle;
    Button btn_learning_menu,btn_go_to_homepage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_learning_menu = findViewById(R.id.btn_learning_menu);
        btn_go_to_homepage = findViewById(R.id.btn_go_to_homepage);


        btn_learning_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(GameEnd.this, LearningMenu.class);
                startActivity(i);
            }
        });
        ...
        btn_go_to_homepage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(GameEnd.this, Home.class);
                startActivity(i);
            }
        });
