...
public class AddGame extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Q = getResources().getStringArray(R.array.questions_game_add);
        A = getResources().getStringArray(R.array.answers_game_add);
                                               ...
                                               if (view.getId() == R.id.iv_alien) {
                                                   if (ans_a == random_Q){
                                                       ...
                                                       if (num >= Q.length) {
                                                           ...
                                                           Intent i = new Intent(AddGame.this, GameEnd.class);
                                                           startActivity(i);
                                                       }
                                                       //num+=1;
                                                       if(num != Q.length){
