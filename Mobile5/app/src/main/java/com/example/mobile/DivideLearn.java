...
public class DivideLearn extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    NavigationView nv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learn_divide);
        ...
        tv_title = findViewById(R.id.tv_title_divide);
        tv_0=findViewById(R.id.tv_0_divide);
        tv_20 = findViewById(R.id.tv_20_divide);
        tv_40 = findViewById(R.id.tv_40_divide);
        tv_60 = findViewById(R.id.tv_60_divide);
        tv_80 = findViewById(R.id.tv_80_divide);
        tv_100 = findViewById(R.id.tv_100_divide);
        iv_learn = findViewById(R.id.iv_learn_divide);
        progressBar = findViewById(R.id.progressBar_divide);
        btn_taptonext = findViewById(R.id.btn_taptonext_divide);
