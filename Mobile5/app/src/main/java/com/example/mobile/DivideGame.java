...
public class DivideGame extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Q = getResources().getStringArray(R.array.questions_game_divide);
        A = getResources().getStringArray(R.array.answers_game_divide);
                    ...
                    if (view.getId() == R.id.iv_alien) {
                        if (ans_a == random_Q){
                            ...
                            if (num == Q.length) {
                                ...
                                Intent i = new Intent(DivideGame.this, GameEnd.class);
                                startActivity(i);
                            }
                            if(num != Q.length){
                            //set question
